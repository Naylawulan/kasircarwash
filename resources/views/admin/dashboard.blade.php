...
<div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="{{url('/kasir')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
...
<script>
    $(document).ready(function() {
     ...
     let transaksi = @json($groupTransaksi);
      Object.keys(transaksi).map((val,i) => {
        let index = areaChartData.labels.indexOf(val);
        areaChartData.datasets[0].data[index] = transaksi[val].length;
      })
